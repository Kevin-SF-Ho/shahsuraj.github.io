...
A pixel-perfect clone of [karlgonsalves.com](https://karlgonsalves.com/) built in 48 hours. Not a copy-paste job. Not an iframe embed. Built from scratch using modern tools, AI-assisted workflows, and pure execution.
...
│ ├── customized.css # Custom animations & utilities
│ └── normalize.css # Cross-browser consistency
├── js/
│ ├── customized.js # Animation engine (3D scroll, parallax)
...
Clone the repo
git clone https://github.com/shahsuraj0204/shahsuraj.github.io.git

Navigate to directory
cd shahsuraj.github.io
...
This is a cloning exercise for an internship application. Original design by [Karl Gonsalves](https://karlgonsalves.com/).
